...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/TermuxTahmid/tahmid-approval.txt/blob/main/tahmid-freefile-approval.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(" \033[1;32m Note : Paid Tolls Free  TAHMID RISHA \033[1;37m")
		print ("")
